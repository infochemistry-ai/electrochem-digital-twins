...
class Trainer:
    ...
    def train_step(self):
        ...
        train_true_vah.extend(np.transpose(vah.detach().cpu().numpy()[0]))
        train_predicted_vah.extend(np.transpose(vah_hat.detach().cpu().numpy()[0]))
    ...
    def val_step(self):
        ...
        val_true_vah.extend(np.transpose(vah.detach().cpu().numpy()[0]))
        val_predicted_vah.extend(np.transpose(vah_hat.detach().cpu().numpy()[0]))
